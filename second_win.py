...
from PyQt5.QtWidgets import(QApplication, QWidget, QLabel, QVBoxLayout, QHBoxLayout, QMessageBox, QLineEdit, QPushButton)
...
class TestWin(QWidget):
    ...
    def initUI(self):
        ...
        self.sendresult = QPushButton(txt_sendresults)
